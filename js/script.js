...
window.ityped.init(document.querySelector('.iTyped'), {
    strings: ["I'm a Junior Web Developer", "I love HTML", 'I Love Laravel', 'I Love Python', 'I Love Github', 'I Love SQL'],
    loop: true
});
...
const filterContainer = document.querySelector('.certificate-filter'),
    ...
    portfolioItems = document.querySelectorAll('.certificate-item'),
    totalCertificateItem = portfolioItems.length;
...
function changeItem() {
    let imgSrc = portfolioItems[itemIndex].querySelector('.certificate-img img').getAttribute('src');
